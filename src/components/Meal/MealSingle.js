        ...
        <section className='sc-details bg-white'>
          <div className='details-head grid'>
            ...
            <div className='details-intro'>
              <div className='search-bar text-white' >
              <input type="text" placeholder="Modify your Recipe..."  
              // value={searchTerm} 
              // onChange={handleSearchInputChange} 
              color='#FFF'
              className='input-field' />
              <CiSearch size = {25}  style={{paddingTop: '5px', paddingBottom: '0px'}}className = "search-icon" />
              </div>
